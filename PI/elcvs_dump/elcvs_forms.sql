...
CREATE TABLE `forms` (
  ...
  `begin` date NOT NULL,
  `end` date NOT NULL,
  `degreet` varchar(5) NOT NULL,
  `degree` varchar(45) NOT NULL,
  `result` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_forms_info1_idx` (`pid`),
  CONSTRAINT `fk_forms_info1` FOREIGN KEY (`pid`) REFERENCES `info` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
