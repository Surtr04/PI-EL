...
CREATE TABLE `activities` (
  ...
  `info` text NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo_UNIQUE` (`key`),
  KEY `fk_activities_institutions1_idx` (`inst`),
  CONSTRAINT `fk_activities_institutions1` FOREIGN KEY (`inst`) REFERENCES `institutions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
