...
CREATE TABLE `nationalities` (
  ...
  PRIMARY KEY (`info_id`,`nat`),
  KEY `fk_nationalities_info1_idx` (`info_id`),
  CONSTRAINT `fk_nationalities_info1` FOREIGN KEY (`info_id`) REFERENCES `info` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
