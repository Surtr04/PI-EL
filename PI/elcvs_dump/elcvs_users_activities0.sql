...
CREATE TABLE `users_activities` (
  ...
  KEY `fk_users_activities_info1_idx` (`user_id`),
  KEY `fk_users_activities_activities1_idx` (`activity_id`),
  CONSTRAINT `fk_users_activities_info1` FOREIGN KEY (`user_id`) REFERENCES `info` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_activities_activities1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
