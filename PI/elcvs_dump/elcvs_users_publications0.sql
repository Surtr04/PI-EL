...
CREATE TABLE `users_publications` (
  ...
  PRIMARY KEY (`info_id`,`publications_id`),
  KEY `fk_users_publications_publications1_idx` (`publications_id`),
  CONSTRAINT `fk_publications_info1` FOREIGN KEY (`info_id`) REFERENCES `info` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_publications_publications1` FOREIGN KEY (`publications_id`) REFERENCES `publications` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
