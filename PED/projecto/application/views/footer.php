...
<p>Copyright @ António Silva e Rui Brito, 2012/2013. Todos os direitos reservados.
	...
	?>
    <br/>
    <a rel="language" href="<?php echo TPL::base(); ?>langs/pt"><img alt="Português" style="border-width: 0" src="<?php echo TPL::base(); ?>images/Portugal.png"/>
	<a rel="language" href="<?php echo TPL::base(); ?>langs/en"><img alt="Inglês" style="border-width: 0" src="<?php echo TPL::base(); ?>images/UK.png"/>
</p>
